...
const TransactionEntryCard: React.FC<TransactionEntryCardProps> = ({ transactionEntry }) => {
    ...
    useEffect(() => {
        console.log(transactionEntry.id)
        ...
        <Card className="w-[500px]">
            <CardHeader className="flex gap-3">
                ...
                <div className="flex flex-col">
                    <p className="text-md">{transactionEntry.title}</p>
                            ...
                            <TableBody>
                                {usersDetails.map((user, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>{relatedUsers[index].amount}</TableCell>
            ...
            <CardFooter className="px-2 flex justify-center">
                <p className="flex justify-center items-center">Total Transaction Amount: {transactionEntry.amount}</p>
            </CardFooter>
        </Card>
    );
};
